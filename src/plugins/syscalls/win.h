...
public:
    ...
    void print_syscall(drakvuf_t drakvuf, drakvuf_trap_info_t* info, int nr, std::string&& module, const syscalls_ns::syscall_t* sc, const std::vector<uint64_t>& args, privilege_mode_t mode, std::optional<std::string> from_dll);
